...
<?php
if (isset($_GET['edit_paddy_buy'])){

		$id = $_GET['edit_paddy_buy'];
                                                 ...
                                                 <div class="form-group row">
								 					<label for="paddy_name"  class="col-sm-3 text-right control-label col-form-label" >Paddy Type</label>
                                                         ...
                                                         <div class="form-group row">
																	...
																	<div class="col-sm-6">
																		 <input type="text" name="reason_less_buy_price" value="<?php echo $reason_less_buy_price; ?>" autocomplete="off" required class="form-control"  id="reason_less_buy_price" placeholder="Buy Price">
																		</div>
														 </div>
														...
														<div class="form-group row">
																	 <label for="farmer_name" class="col-sm-3 text-right control-label col-form-label">Total Weight</label>
																		<div class="col-sm-6">
																			<input type="number" name="total_weight" value="<?php echo $total_weight; ?>" autocomplete="off" required class="form-control"  id="1kg_selling_price" placeholder="Selling Price">
																		</div>
														</div>
...
<?php
		 if(isset($_POST['Update'])){
		    ...
		    $paddy_type = $_POST['paddy_name'];
		    $reason_less_buy_price = $_POST['reason_less_buy_price'];
		    $total_weight = $_POST['total_weight'];
					

			 $sql = "update paddy_buy set  farmer_reg_no='$farmer_reg_no', paddy_type='$paddy_type', 1kg_buy_price='$buy_price', reason_less_buy_price='$reason_less_buy_price', total_weight='$total_weight' where row_id='$id'";
