	...
	if(isset($_POST["insert"]))
	{
				...
				$fimat=$mat.$reg_center_id;
				 ...
				 $reg_center_address =$_POST['reg_center_address'];
			    		  ...
			    		  $sql = "INSERT INTO reginal_center(reg_center_id, reg_center_name, reg_center_telno, reg_center_email, reg_center_address) VALUES ('$fimat','$reg_center_name','$reg_center_telno','$reg_center_email','$reg_center_address')";
								                ...
								                <div class="row">
								                    <div class="col-md-12">
								                        <div class="card card-body printableArea">
																					<div align="center">
																				    <button type="button" name="add" id="add" class="btn btn-success">Add Reginal Center Details</button>
																				   </div>
																					    ...
																					    <form id="image_form" action="" method="post" enctype="multipart/form-data">
																								...
																								<div class="form-group row">
																										 <label for="reg_center_name" class="col-sm-3 text-right control-label col-form-label">Reginal Center Name</label>
																											 <div class="col-sm-6">
																												 <input type="text" name="reg_center_name" autocomplete="off" required class="form-control"  id="reg_center_name" placeholder="Reginal Center Name">
																											 </div>
																								</div>
																								<div class="form-group row">
																										 <label for="reg_center_telno" class="col-sm-3 text-right control-label col-form-label">Reginal Center Phone Number</label>
																											 <div class="col-sm-6">
																												 <input type="number" name="reg_center_telno" autocomplete="off" required class="form-control"  id="reg_center_telno" placeholder="Reginal Center Phone Number">
																											 </div>
																								</div>
																								<div class="form-group row">
																										 <label for="reg_center_email" class="col-sm-3 text-right control-label col-form-label">Reginal Center Email</label>
																											 <div class="col-sm-6">
																												 <input type="email" name="reg_center_email" autocomplete="off" required class="form-control"  id="reg_center_email" placeholder="Reginal Center Email">
																											 </div>
																								</div>
																								<div class="form-group row">
																										 <label for="reg_center_address" class="col-sm-3 text-right control-label col-form-label">Reginal Center Address</label>
																											 <div class="col-sm-6">
																												 <input type="text" name="reg_center_address" autocomplete="off" required class="form-control"  id="reg_center_address" placeholder="Reginal Center Address">
																											 </div>
																								</div>
																								...
																								<div class="card-body">
																												...
																												<div class="table-responsive"><!-- table-responsive begin -->
																														<table id="zero_config" class="table table-striped table-bordered"><!-- table table-striped table-bordered table-hover begin -->
																																...
																																<thead><!-- thead begin -->
																																		<tr><!-- tr begin -->
																																			<th> Reginal Center ID </th>
																																			<th> Reginal Center Name </th>
																																			<th> Reginal Center Phone Number </th>
																																			<th> Reginal Center Email </th>
																																			<th> Reginal Center Address </th>
																																			<th> Date </th>
																																			<th> Modify </th>
																																		</tr><!-- tr finish -->
																																</thead><!-- thead finish -->
																																...
																																<tbody><!-- tbody begin -->
																																		...
																																		?>
																													<tr><!-- tr begin -->
																															<td> <?php echo $reg_center_id; ?> </td>
																															<td> <?php echo $reg_center_name; ?> </td>
																															<td> <?php echo $reg_center_telno; ?> </td>
																															<td> <?php echo $reg_center_email; ?> </td>
																															<td> <?php echo $reg_center_address; ?> </td>
																															<td> <?php echo $date; ?> </td>
																													<td>
